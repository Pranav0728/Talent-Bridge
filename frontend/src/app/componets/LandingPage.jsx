        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="bg-green-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-green-500 transition duration-300">
                Post a Job
              </button>
            </div>
          </div>
      ...
      <section id="features" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose TalentBridge?</h3>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We provide comprehensive tools for both job seekers and employers to make the perfect match.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Advanced filters and AI-powered matching to find the perfect job opportunities.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h4 className="text-xl font-semibold mb-2">Easy Job Posting</h4>
              <p className="text-gray-600">Post jobs in minutes with our intuitive interface and reach qualified candidates instantly.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h4 className="text-xl font-semibold mb-2">Application Management</h4>
              <p className="text-gray-600">Track, manage, and respond to applications efficiently with our streamlined dashboard.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Enterprise-grade security with verified profiles and encrypted communications.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Join TalentBridge today and take the next step in your career or hiring journey.
          </p>
